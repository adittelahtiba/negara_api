        ...
        <ul class="nav" id="side-menu">
            <li class="user-pro">
                <a href="#" class="waves-effect">
                    <img src="<?= base_url(); ?>assets/BackEnd/img/profile/Foto_Profil.jpg" alt="user-img" class="img-circle">
                    <span class="hide-menu">Adit tester<span class="fa arrow"></span><span class="label label-rouded label-inverse pull-right">2</span></span>
                </a>
            ...
            <li class="devider"></li>
            <li><a href="<?= base_url(); ?>Templates/undangan/A01" class="waves-effect"><i class="mdi mdi-av-timer fa-fw"></i> <span class="hide-menu">Galeri</span></a></li>
            ...
            <div class="text-center">
                <button class="fcbtn btn btn-outline btn-success btn-1f">Daftar</button>
                <button class="fcbtn btn btn-outline btn-danger btn-1f">Masuk</button>
            </div>
            <!-- tabel data -->
